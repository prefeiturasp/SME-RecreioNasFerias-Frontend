...
export const TituloListagemEdicoes = styled.p`
  margin-bottom: 1rem;
...
export const ContainerTabelaEdicoes = styled.div`
  width: 100%;
  overflow-x: auto;
`

export const TabelaEdicoes = styled.table`
  width: 100%;
  min-width: 56rem;
...
export const CabecalhoTabelaEdicoes = styled.thead`
...
export const CorpoTabelaEdicoes = styled.tbody`
  td {
    padding: 0.75rem 1rem;
    border: 1px solid #e1e1e1;
    font-family: var(--font-family);
...
export const BotaoAcaoEdicao = styled.button`
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 1.75rem;
